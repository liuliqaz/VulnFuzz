...
static u8 save_if_interesting(char** argv, void* mem, u32 len, u8 fault) {
  ...
  //***************************************here to add save path method******************************************
  //use static arg "int count"
  //use local arf "char buffer[]"
  snprintf(buffer, 100, "cp /home/liuli/mylog/testtrace.log /home/liuli/mylog/%d_%d_testtrace.log", count++, fault);
  system(buffer);
  system("rm /home/liuli/mylog/testtrace.log");
...
static char** get_qemu_argv(u8* own_loc, char** argv, int argc) {
  ...
  void* mem;
  void* ret;
  ret = malloc(sizeof(char*) * (argc + 4) + ALLOC_OFF_TOTAL);
  mem = ret;
  new_argv = memset(mem, 0, sizeof(char*) * (argc + 4));
  //-----------ck_alloc-----------------
